...
/*  propTypes:{
  ...
  _handleOnClick: function(event){
    ...
    this.setState({value: val, isDeployed: false}, this.props.handleOnClick);
  },
  /**
  ...
  render: function renderScopeComponent(){
    return (
      <div className={this.props.className + " qs-scope"}>
        <div className={`qs-icon qs-scope-deploy-${(this.state.isDeployed ? "up": "down")}`} onClick={this.handleDeployClick}>
          <div className={this.scopeStyle()}>{this.scopeLabel()}</div>
