    ...
    */
    render: function render() {
        return React.createElement(
            ...
            React.createElement('br', null),
            React.createElement('br', null),
            React.createElement(Button, { icon: 'mood', color: 'colored', shape: 'icon', type: 'button', handleOnClick: function () {
                    return alert('click bouton');
                } }),
            React.createElement('br', null),
            React.createElement('br', null),
            React.createElement(Button, { icon: 'mood', color: 'announcement', shape: 'mini-fab', type: 'button', handleOnClick: function () {
                    return alert('click bouton');
                } })
        );
    }
