    ...
    */
    renderContent: function renderContent() {
        return React.createElement(
            ...
            this.autocompleteFor('city', { codeResolver: codeResolver, searcher: searcher }, { selectionHandler: function selectionHandler(data) {
                    alert('Code : ' + data.code + ', value: ' + data.value);
                } }),
