...
const Modal = FocusComponents.application.modal.component;
                ...
                <div style={this.style} className="demo-card-wide mdl-card mdl-shadow--2dp">
                    ...
                    <div className="mdl-card__supporting-text" style={this.divSupportText}>
                        <h5>
                            ...
                            <br/><br/>
                            Click on <div className="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect"><i  className="material-icons">notifications</i></div> icon to have a menu slidding modal
                            <br/>
                            Click on <div className="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect"><i  className="material-icons">chat</i></div> icon to have a right slidding modal
                            <br/>
                            And <button className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onClick={this.makeTheSecondModalPop}><b>Click here</b></button> to display a fade-in modal example.
                            <br/>
                        </h5>
                    </div>
                </div>
        ...
        return (
            <Modal ref='modal' size='small' type='from-menu' modal={false}>
                ...
                <h4>
                    ...
                    <br/>
                    <br/>
                    Here, you have a <i>"small"</i> Modalg coming <i>"from-menu"</i> with a <i>"false"</i> modal !
                    <br/>
...
const SecondModal = React.createClass({
    toggleModal() {
...
const ThirdModal = React.createClass({
    toggleModal() {
