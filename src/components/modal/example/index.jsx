...
const Modal = FocusComponents.components.Modal;
        ...
        return (
            <Layout MenuLeft={MenuLeft}>
                ...
                <div className="popins-container">
                    <Modal ref="full" type="full">
                        <FakeContent />
                    </Modal>
                    <Modal ref="from-menu" type="from-menu">
                        ...
                        <Button handleOnClick={this.popinOpener('full')} label='Open full popin' />
                        <FakeContent />
                        <Modal ref="from-right-no-overlay" overlay={false} type="from-right">
                            <FakeContent />
                        </Modal>
                    </Modal>
                    <Modal ref="from-menu-second" overlay={false} level={1} type="from-menu">
                        <FakeContent />
                    </Modal>
                    <Modal ref="from-right" type="from-right">
                        test
                        <FakeContent />
                    </Modal>
                </div>
