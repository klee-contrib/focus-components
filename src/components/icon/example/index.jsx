const Icon = FocusComponents.components.Icon;
...
function IconsExample() {
    return(
        <div>
            ...
            <Icon library='font-awesome' name='map' onClick={() => {console.log('Hello font-awesome icon map !')}}/>
            <Icon library='font-awesome' name='youtube-play' onClick={() => {console.log('Hello font-awesome icon youtube-play !')}}/>
            <br/>
        </div>
    );
}

module.exports = IconsExample;
