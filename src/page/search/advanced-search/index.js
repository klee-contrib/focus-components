...
import { upperFirst, camelCase as camel, isFunction, reduce } from 'lodash';
...
const AdvancedSearch = {
    ...
    */
    componentWillMount() {
        ...
        ['facets', 'results', 'total-count'].forEach((node) => {
            store[`add${upperFirst(camel(node))}ChangeListener`](this._onStoreChangeWithoutSearch);
        });
    ...
    */
    componentWillUnmount() {
        ...
        ['facets', 'results', 'total-count'].forEach((node) => {
            this.props.store[`remove${upperFirst(camel(node))}ChangeListener`](this._onStoreChangeWithoutSearch);
        });
...
const builtComp = builder(AdvancedSearch);
